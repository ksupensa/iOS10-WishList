...
SWIFT_CLASS("_TtC8WishList11AppDelegate")
...
SWIFT_CLASS("_TtC8WishList15CustomTextField")
...
@interface Image (SWIFT_EXTENSION(WishList))
...
@interface Item (SWIFT_EXTENSION(WishList))
...
SWIFT_CLASS("_TtC8WishList8ItemCell")
...
SWIFT_CLASS("_TtC8WishList13ItemDetailsVC")
@interface ItemDetailsVC : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified thumbImage;
...
@property (nonatomic, strong) Item * _Nullable itemToEdit;
...
@interface ItemType (SWIFT_EXTENSION(WishList))
...
SWIFT_CLASS("_TtC8WishList6MainVC")
@interface MainVC : UIViewController <UIScrollViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
@property (nonatomic, weak) IBOutlet UISegmentedControl * _Null_unspecified segment;
@property (nonatomic, strong) NSFetchedResultsController<Item *> * _Null_unspecified NSFRController;
- (void)viewDidLoad;
...
- (void)attemptFetch;
- (IBAction)segmentChanged:(id _Nonnull)sender;
...
@interface Store (SWIFT_EXTENSION(WishList))
...
SWIFT_CLASS("_TtC8WishList7StoreVC")
@interface StoreVC : UIViewController <UIPickerViewDelegate, UIPickerViewDataSource>
@property (nonatomic, weak) IBOutlet UIPickerView * _Null_unspecified storePicker;
@property (nonatomic, weak) IBOutlet CustomTextField * _Null_unspecified storeNameField;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified listLabel;
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified deleteButton;
@property (nonatomic, copy) NSArray<Store *> * _Nonnull stores;
- (void)viewDidLoad;
- (void)dismissKeyboard;
...
- (IBAction)deletePressed:(UIBarButtonItem * _Nonnull)sender;
- (void)getStores;
- (void)storesVisibility;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


@interface UIColor (SWIFT_EXTENSION(WishList))
...
@interface UIView (SWIFT_EXTENSION(WishList))
